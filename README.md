...
英文文章或新闻改写为精简、地道的中文（博客/公众号发布）。逐句分诊（keep+改写/merge/drop）+ 表达规则确认制（R1–R10 只增不减，防忘规则）+ 金句原汁原味保留 `中文（English）` + 多维质量门（忠实度/翻译腔/精简/AI 味 + 资深编辑/读者视角）。压缩重写，不保全全部信息、不逐字对应。

**示例：** `把这篇文章改写成中文发公众号：https://example.com/tech-article`
