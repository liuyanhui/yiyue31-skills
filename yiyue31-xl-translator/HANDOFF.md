...
> 最后更新：2026-09-15 晚（chunk 01 审校第 1 波 5 单元在途——单元 04 波次）。
...
| chunk 01 审校 | ⏳ 第 1 波 5 单元在途（两波制 ≤5）；第 2 波 7 单元待回传后派 |
| **下一步** | 12 单元齐 → 读报告修复（Step 7）→ 重跑机械 → stale 重审；过审后 chunk 02（范文锚 anchor.md 落盘） |
...
| 04 | chunk 01 审校 12 单元 | ⏳ 波 1/3（5 在途） | sha a=9536ceae6a92 b=67e5f5323a5a |
